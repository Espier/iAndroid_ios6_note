...
public class NoteEditAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null || convertView.getTag() == null) {
			...
			holder.tvLeft=(TextView)holder.navigation.findViewById(R.id.tv_left);
...
//			holder.isShow=holder.llContainer.isShow;
			...
			System.out.println("holder.llContainer.isShow111="+holder.llContainer.isShow);
...
//					new Date());
			...
			String dateStr = DateFormat.getDateInstance(DateFormat.FULL).format(
					new Date());
			holder.tvDate.setText(dateStr.substring(5, 10));
		} else {
		...
		holder.tvRight.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Note note=new Note(1, holder.etContent.getText().toString(),date);
			...
			public void onCheckedChanged(RadioGroup group, int checkedId) {
				// TODO Auto-generated method stub
					...
					if (checkedId == holder.rbBrown.getId()) {
						holder.etContent.setTextColor(context.getResources().getColorStateList(
								R.color.text_brown));
